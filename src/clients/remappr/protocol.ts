...
// The DTO itself is firmware-neutral (see ../configEditing); only the wire
// parse below is Remappr-specific. Re-exported so existing protocol importers
// keep working.
export type { LinkLimitKnob }
